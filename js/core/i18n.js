(function () {
    ...
    var translations = {
        es: {
            ...
            "config.mascota.titulo": "Mascota Brote",
            "config.mascota.desc":   "Brote, el espíritu de planta, anuncia las notificaciones hablando en pantalla.",
            "config.roam.titulo":    "Brote en movimiento",
            "config.roam.desc":      "Brote acecha por la pantalla, sigue el cursor y se posa sobre las cards y la barra.",
        ...
        en: {
            ...
            "config.mascota.titulo":  "Brote pet",
            "config.mascota.desc":    "Brote the plant spirit announces notifications by speaking on-screen.",
            "config.roam.titulo":     "Roaming Brote",
            "config.roam.desc":       "Brote stalks the screen, follows the cursor and perches on cards and the bar.",
