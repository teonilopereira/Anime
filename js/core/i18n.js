(function () {
    ...
    var translations = {
        es: {
            ...
            "config.avatar.titulo":      "🎨 Generá tu avatar en pixel art",
            "config.avatar.placeholder": "ej: guerrero ninja con capa roja",
            "config.avatar.generar":     "GENERAR",
            "config.avatar.hint":        "Se crea con IA y queda como tu foto de perfil.",
            "config.mascota.elegir":     "🐾 Elegí tu mascota",
            "mascotas.titulo":           "ELEGÍ TU MASCOTA",
            "mascotas.subtitulo":        "Tocá una mascota para que te acompañe por la app.",
            "mascotas.nota":             "El cambio se aplica al instante y se guarda en este dispositivo.",
            "mascotas.volver":           "← Volver a configuración",
            ...
            "config.mascota.titulo": "Mascota Rimuru",
        ...
        en: {
            ...
            "config.avatar.titulo":      "🎨 Generate your pixel-art avatar",
            "config.avatar.placeholder": "e.g. ninja warrior with a red cape",
            "config.avatar.generar":     "GENERATE",
            "config.avatar.hint":        "Created with AI and set as your profile picture.",
            "config.mascota.elegir":     "🐾 Choose your mascot",
            "mascotas.titulo":           "CHOOSE YOUR MASCOT",
            "mascotas.subtitulo":        "Tap a mascot to have it follow you around the app.",
            "mascotas.nota":             "The change applies instantly and is saved on this device.",
            "mascotas.volver":           "← Back to settings",
            ...
            "config.mascota.titulo":  "Rimuru pet",
