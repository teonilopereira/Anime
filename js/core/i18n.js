(function () {
    ...
    var translations = {
        es: {
            ...
            "config.mascota.titulo": "Mascota Slime",
            "config.mascota.desc":   "Un slime en pantalla anuncia las notificaciones hablando.",
            "config.roam.titulo":    "Slime en movimiento",
            "config.roam.desc":      "El slime pasea por la pantalla y se posa sobre las cards y la barra.",
        ...
        en: {
            ...
            "config.mascota.titulo":  "Slime pet",
            "config.mascota.desc":    "An on-screen slime announces notifications by speaking.",
            "config.roam.titulo":     "Roaming slime",
            "config.roam.desc":       "The slime wanders the screen and perches on cards and the bar.",
